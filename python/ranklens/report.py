...
<body><main>
  <header><h1>RankLens</h1><p>Evidence-driven MPI performance report · schema v1</p></header>
  ...
  <footer>Generated by RankLens v0.1. Recommendations are hypotheses to validate with controlled benchmarks, not promised speedups.</footer>
</main></body></html>
"""
